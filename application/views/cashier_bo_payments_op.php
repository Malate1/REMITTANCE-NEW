<main>
    ...
    <div class="container-fluid">
        <h4 class="mt-4">Prebooking BO Payments</h4>
        <a onclick=backpage()>
        ...
        <div class="card mb-4">
            <div class="card-header">
                ...
                <?php if (!empty($row->full_name) && !empty($result2)): ?>
                    BO Payments of salesman - <b style="font-size: 20px"><?php echo $row->full_name; ?></b>
                    ...
                    <table class="table sm_checks compact" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <?php 
                                ...
                                echo '<a title="Delete Payment" style="color: red;cursor: pointer" onclick=delete_bo_op('.$row2['bo_id'].')><i class="fas fa-trash fa-lg"></i></a>&nbsp;&nbsp;';
