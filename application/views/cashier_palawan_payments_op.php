<main>
    ...
    <div class="container-fluid">
        <h4 class="mt-4">Prebooking Palawan Remittance</h4>
        <a onclick=backpage()>
                    ...
                    <table class="table sm_checks compact" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <?php 
                                ...
                                echo '<a title="Delete Payment" style="color: red;cursor: pointer" onclick=delete_palawan_op('.$row2['pay_id'].')><i class="fas fa-trash fa-lg"></i></a>&nbsp;&nbsp;';
