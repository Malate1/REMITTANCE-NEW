<?php
    ...
    $pdf->Cell(250,15,"GROCERY DAILY SUMMARY COLLECTION REPORT",0,1,'C');
    ...
    $pdf->Ln('8');
    $pdf->setx('5');
    $pdf->Cell(45,8,"Total >>>",1,0,'R',true);
    $pdf->Cell(18,8,"",1,0,'C',true);
    ...
    $pdf->Cell(27,8,number_format($result2->total_collection,2),1,0,'R',true);
