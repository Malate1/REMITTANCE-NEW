<main>
    ...
    <div class="container-fluid">
        <h4 class="mt-4">Salesman Bad Order Payments</h4><br/>
        <div class="col-md-12" style="width: 100%">
            ...
            <div class="form-row">
                ...
                <button type="submit" style="display: none;" class="btn btn-primary" id="xtruckButtonRef" onclick="cashiersm_form_date_op_bo_ref()">Generate BO Payment/s by Ref No</button>
                    <button type="submit"  class="btn btn-primary" id="xtruckButton" onclick="cashiersm_form_date_op_bo()">Generate BO Payment/s</button>
                </div>
            </div>
