<main>
    ...
    <div class="container-fluid">
        <h4 class="mt-4">Salesman Denomonination/s</h4><br/>
        <div class="col-md-12" style="width: 100%">

            <div class="form-row"> 
                <div class="form-group col-md-3">
                    
                    <p>Per SM or Per Denomination No.</p>
                        ...
                        <label for="si">Per Denomination No.</label><br>
                ...
                <div class="form-row" id="perSi" style="display: none"> 
                    <div class="form-group col-md-3">
                        <label for="ref_no">Enter Denomination No. </label>
                ...
                <div class="form-row" id="perSm" >
                    ...
                    <div id="oplan" class="form-group col-md-3" style="display: none">
                        <label for="sm">Oplan Salesman</label> <br>
                    ...
                    <div id="xt" class="form-group col-md-3" style="display: inline-block ">
            ...
            <div class="form-row">
                ...
                <button type="submit" style="display: none;" class="btn btn-primary" id="xtruckButtonRef" onclick="cashiersm_form_date_xt_denom_no()">Generate Remittance by Denom No</button>
                    <!-- <button type="submit"  class="btn btn-primary" id="xtruckButton" onclick="cashiersm_form_date_xt_denom()">Generate Remittances/s</button> -->
                    <button type="submit" style="display: inline-block ;" class="btn btn-primary" id="xtruckButton" onclick="cashiersm_form_date_xt_denom()">Generate XTRUCK Remittances/s</button>
                    
                    <button type="submit" style="display: none;" class="btn btn-primary" id="oplanButton" onclick="cashiersm_form_date_op_denom()">Generate OPLAN Remittances/s</button>
                </div>
            </div>
