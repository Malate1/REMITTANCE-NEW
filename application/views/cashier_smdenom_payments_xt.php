                            ...
                            <?php 
                                ...
                                //if($pay_stat=="FILED") {   
                                    if($row2['pay_type'] == 'Cash') {
                                        echo '<a title="Convert Cash" style="color: green;cursor: pointer" data-toggle="modal" data-controls-modal="#editSmCheck" data-backdrop="static" data-keyboard="false" data-target="#editSmCheck" onclick="cash_to_check_xt('.$row2['pay_id'].')"><i class="fas fa-pen fa-lg"></i></a>&nbsp;&nbsp;';
                                    }else{
                                        echo '<a title="Edit Check" style="color: orange;cursor: pointer" data-toggle="modal" data-controls-modal="#editSmCheck" data-backdrop="static" data-keyboard="false" data-target="#editSmCheck" onclick="edit_sm_check_ldi_xt('.$row2['pay_id'].')"><i class="fas fa-edit fa-lg"></i></a>&nbsp;&nbsp;';

                                        echo '<a title="Convert Check" style="color: red;cursor: pointer" onclick=change_check_xt('.$row2['pay_id'].')><i class="fas fa-coins fa-lg"></i></a>&nbsp;&nbsp;';
                                    }

                                    echo '<a title="Delete Payment" style="color: red;cursor: pointer" onclick=delete_check_xt('.$row2['pay_id'].')><i class="fas fa-trash fa-lg"></i></a>&nbsp;&nbsp;';
                                    ...
                                    // echo '<a title="Minus Pay Amount" style="color: skyblue;cursor: pointer" data-toggle="modal" data-controls-modal="#editSmCheck" data-backdrop="static" data-keyboard="false" data-target="#editSmCheck" onclick=edit_sm_check_ldi_tax_op_minus('.$row2['pay_id'].')><i class="fas fa-minus fa-lg"></i></a>&nbsp;&nbsp;';
