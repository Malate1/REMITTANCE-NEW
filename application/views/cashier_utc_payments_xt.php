<main>
    ...
    <div class="container-fluid">
        <h4 class="mt-4">Extruck Salesman Under the Cup Remittance</h4>
        <a onclick=backpage()>
        ...
        <div class="card mb-4">
            <div class="card-header">
                ...
                <?php if (!empty($row->full_name) && !empty($result2)): ?>
                    Under the Cup Payments of salesman - <b style="font-size: 20px"><?php echo $row->full_name; ?></b>
                    ...
                    <table class="table sm_checks compact" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                echo '<a title="Delete Payment" style="color: red;cursor: pointer" onclick=delete_utc_xt('.$row2['pay_id'].')><i class="fas fa-trash fa-lg"></i></a>&nbsp;&nbsp;';
