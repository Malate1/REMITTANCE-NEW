        ...
        <div class="col-xl-12" style="width: 100%">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <button type="submit" style="display: inline-block;" class="btn btn-primary" id="oplanButton" onclick="colsum_date()">Generate Report</button>

                    <button type="submit"  class="btn btn-success" onclick=colsum_date_excel()>Generate Excel</button>
