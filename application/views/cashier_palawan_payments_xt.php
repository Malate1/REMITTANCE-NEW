<main>
    ...
    <div class="container-fluid">
        <h4 class="mt-4">Extruck Salesman Palawan Remittance</h4>
        <a onclick=backpage()>
        ...
        <div class="card mb-4">
            <div class="card-header">
                ...
                <?php if (!empty($row->full_name) && !empty($result2)): ?>
                    Palawan Remittance of salesman - <b style="font-size: 20px"><?php echo $row->full_name; ?></b>
                ...
                <div class="table-responsive">
                    <table class="table sm_checks compact" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo $row2['date_remitted']; ?></td>
                                <td><?php echo $row2['sm_code']; ?></td>
                                <td><?php echo $row2['sm_name']; ?></td>
                            ...
                            <?php 
                                ...
                                echo '<a title="Edit Check" style="color: orange;cursor: pointer" data-toggle="modal" data-controls-modal="#editSmCheck" data-backdrop="static" data-keyboard="false" data-target="#editSmCheck" onclick="edit_sm_palawan_ldi_xt('.$row2['pay_id'].')"><i class="fas fa-edit fa-lg"></i></a>&nbsp;&nbsp;';
                               
                                echo '<a title="Delete Payment" style="color: red;cursor: pointer" onclick=delete_palawan_xt('.$row2['pay_id'].')><i class="fas fa-trash fa-lg"></i></a>&nbsp;&nbsp;';
